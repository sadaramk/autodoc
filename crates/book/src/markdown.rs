...
pub fn render(book: &Book, repo_rel: Option<&str>) -> BTreeMap<String, String> {
    ...
    readme.push_str("Open [`index.html`](index.html) for the interactive book. Generated by autodoc; figures are compiled from the `diagrams/*.ir.json` files, which may be edited by hand.\n\n");
    ...
    llms.push_str(&format!(
        "Architecture book generated from source by autodoc. Every claim links to file:line evidence verified against the commit. {}\n\n",
        meta_line(book)
    ));
    llms.push_str("## Pages\n\n");
    for page in &book.pages {
